...
In total, after steps 1--3 we generated a list of 239 US stocks, including 211 stocks with stock assessments that qualified under our defined criteria. The remaining 31 stocks did not meet our assessment criteria. They were excluded from our dataset, although after merging our dataset of assessed stocks with the NOAA landings database, those stocks would later re-enter as unassessed stocks. Of these 211 assessed stocks in our full dataset, 204 assessed stocks were used in our final dataset for analysis (See supplementary dataset). 
