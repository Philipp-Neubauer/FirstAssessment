...
\begin{table}[!ht]
\caption[dataset]{Four assessed stocks were excluded from our analysis, due to unavailable ex-vessel prices in the years leading up to the year of first assessment. The assessment year is the year of first stock assessment.}
